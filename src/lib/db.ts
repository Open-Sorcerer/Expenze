...
if (
  !process.env.EXPO_PUBLIC_REDIS1_URL ||
  !process.env.EXPO_PUBLIC_REDIS1_TOKEN
  // ||
...
export const redis1 = new Redis({
  url: process.env.EXPO_PUBLIC_REDIS1_URL,
  token: process.env.EXPO_PUBLIC_REDIS1_TOKEN,
});
